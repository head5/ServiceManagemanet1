...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="ServiceManagemanet1" generation="1" functional="0" release="0" Id="b90d163b-c639-4221-8c22-cb17c2cfab89" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="ServiceManagemanet1Group" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="WebRole1" generation="1" functional="0" release="0" software="D:\Projects\WebAPI\ServiceManagemanet1\ServiceManagemanet1\csx\Debug\roles\WebRole1" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="-1" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
  ...
  <implements>
    <implementation Id="2be4d865-b716-4fb0-adeb-9f78d5bcd2a2" ref="Microsoft.RedDog.Contract\ServiceContract\ServiceManagemanet1Contract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="f2c367ff-69ca-4fa8-b1df-82777eb43ca5" ref="Microsoft.RedDog.Contract\Interface\WebRole1:Endpoint1@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/ServiceManagemanet1/ServiceManagemanet1Group/WebRole1:Endpoint1" />
          </inPort>
        </interfaceReference>
        <interfaceReference Id="604e544e-9b94-464b-aefa-37722dc605e7" ref="Microsoft.RedDog.Contract\Interface\WebRole1:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/ServiceManagemanet1/ServiceManagemanet1Group/WebRole1:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput" />
          </inPort>
        </interfaceReference>
